...
for f in $inputFolder/*;
	do 
		...
		bsub -q short -W 03:00 -e $HOME/lsf_jobs/LSB_%J.err -o $HOME/lsf_jobs/LSB_%J.log -n 1 -R select[ib] -R rusage[mem=1000] -N -u $USER -J bam2quality$name_no_ext -w sam2bam$filename "perl $HOME/scripts/git/ATACpipe/perl/pebam2quality.pl $outputFolder/$foldername/bam_files/$name_no_ext.bam";
		...
		bsub -q short -W 02:00 -e $HOME/lsf_jobs/LSB_%J.err -o $HOME/lsf_jobs/LSB_%J.log -n 1 -R select[ib] -R rusage[mem=2000] -N -u $USER -J bam2unique$name_no_ext -w bam2sort$name_no_ext "perl $HOME/scripts/git/ATACpipe/perl/pebam2unique.pl $outputFolder/$foldername/sorted_quality/$name_no_ext.bam.quality.sort.bam";
		...
		bsub -q short -W 02:00 -e $HOME/lsf_jobs/LSB_%J.err -o $HOME/lsf_jobs/LSB_%J.log -n 1 -R select[ib] -R rusage[mem=1000] -N -u $USER -J unique2lengths$name_no_ext  -w sam2bamunique$name_no_ext "perl $HOME/scripts/git/ATACpipe/perl/pebam2lengths.pl $outputFolder/$foldername/unique_quality/$name_no_ext.bam.quality.sort.unique.bam";
		...
		bsub -q short -W 04:00 -e $HOME/lsf_jobs/LSB_%J.err -o $HOME/lsf_jobs/LSB_%J.log -n 1 -R select[ib] -R rusage[mem=2096] -N -u $USER -J lengths2plot$name_no_ext -w mvLengths$name_no_ext "Rscript $HOME/scripts/git/ATACpipe/R/lengths.R $outputFolder/$foldername/LENGTHS/$name_no_ext.bam.quality.sort.unique.bam.LENGTHS $name_no_ext";
